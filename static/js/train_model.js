...
const TRAIN_MODEL_API_ENDPOINT = '/api/openai-proxy';
const TRAIN_MODEL_DEFAULT = 'gpt-4o'; // The newest OpenAI model is "gpt-4o" which was released May 13, 2024. Do not change this unless explicitly requested by the user
